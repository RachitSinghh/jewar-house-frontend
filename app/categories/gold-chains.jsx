...
// Sample products data for gold chains
const products = [
  {
    id: 1,
    ...
    description: 'Exquisite handmade gold chain crafted with traditional techniques and premium 22KT gold.',
  },
  {
    id: 2,
    name: 'Super Deluxe Gold Chain',
    price: '₹1,85,000',
    weight: '35g',
    purity: '22KT',
    image: 'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg',
    description: 'Luxurious super deluxe gold chain with intricate design and superior craftsmanship.',
  },
  {
    id: 3,
    ...
    description: 'Classic gold chain design perfect for everyday wear with elegant finish.',
  },
  {
    id: 4,
    ...
    description: 'Contemporary designer gold chain featuring modern patterns and premium quality.',
  },
];

export default function GoldChainsScreen() {
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <View style={styles.headerTitleContainer}>
            ...
            <Text style={styles.headerTitle}>{title || 'GOLD CHAINS'}</Text>
            <View style={styles.headerAccent} />
          </View>
        </LinearGradient>
      </View>
