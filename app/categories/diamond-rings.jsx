...
// Sample products data for diamond rings
const products = [
  {
    id: 1,
  ...
  },
  {
    ...
    description: 'Full eternity band featuring perfectly matched VS2 diamonds in seamless setting.',
  },
  {
    id: 3,
    ...
    description: 'Statement cocktail ring featuring a large center VVS2 diamond with halo setting.',
  },
  {
    id: 4,
    ...
    description: 'Classic wedding band with channel-set VS1 diamonds in timeless design.',
  },
];

export default function DiamondRingsScreen() {
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <View style={styles.headerTitleContainer}>
            ...
            <Text style={styles.headerTitle}>{title || 'DIAMOND RINGS'}</Text>
            <View style={styles.headerAccent} />
          </View>
        </LinearGradient>
      </View>
