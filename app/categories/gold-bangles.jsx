...
// Sample products data for gold bangles
const products = [
  {
    id: 1,
    ...
    description: 'Traditional 22KT gold kada set with antique finish and intricate engravings.',
  },
  {
    id: 2,
    ...
    description: 'Luxurious diamond bracelet featuring premium cut diamonds in 18KT gold modern design.',
  },
  {
    id: 3,
    ...
    description: 'Set of four 22KT gold bangles featuring rubies and diamonds in traditional design.',
  },
  {
    id: 4,
    ...
    description: 'Contemporary designer bracelet with modern patterns and premium 18KT gold.',
  },
];

export default function GoldBanglesScreen() {
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <View style={styles.headerTitleContainer}>
            ...
            <Text style={styles.headerTitle}>{title || 'GOLD BANGLES AND BRACELETS'}</Text>
            <View style={styles.headerAccent} />
          </View>
        </LinearGradient>
      </View>
