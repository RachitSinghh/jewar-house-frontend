...
// Sample products data for silver bangles
const products = [
  {
    id: 1,
    ...
    description: 'Traditional sterling silver kada with engraved patterns and oxidized finish.',
  },
  {
    id: 2,
    ...
    description: 'Delicate sterling silver chain bracelet with adjustable clasp.',
  },
  {
    id: 3,
    ...
    description: 'Set of three sterling silver bangles with different textures and patterns.',
  },
  {
    id: 4,
    ...
    description: 'Contemporary designer bracelet with modern patterns and premium sterling silver.',
  },
];

export default function SilverBanglesScreen() {
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <View style={styles.headerTitleContainer}>
            ...
            <Text style={styles.headerTitle}>{title || 'SILVER BANGLES'}</Text>
            <View style={styles.headerAccent} />
          </View>
        </LinearGradient>
      </View>
