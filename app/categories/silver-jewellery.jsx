...
// Sample products data for silver jewellery
const products = [
  {
    id: 1,
    ...
    description: 'Beautiful oxidized silver necklace with traditional tribal patterns and antique finish.',
  },
  {
    id: 2,
    ...
    description: 'Elegant sterling silver chain featuring freshwater pearls with modern design.',
  },
  {
    id: 3,
    name: 'Temple Silver Necklace',
    price: '₹15,500',
    weight: '75g',
    purity: '92.5%',
    image: 'https://images.pexels.com/photos/1454171/pexels-photo-1454171.jpeg',
    description: 'Traditional temple jewelry silver necklace with intricate deity motifs and gemstone accents.',
  },
  {
    id: 4,
    name: 'Silver Choker Set',
    price: '₹9,800',
    weight: '38g',
    purity: '92.5%',
    image: 'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg',
    description: 'Contemporary silver choker set with matching earrings in modern design.',
  },
];

export default function SilverJewelleryScreen() {
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <View style={styles.headerTitleContainer}>
            ...
            <Text style={styles.headerTitle}>{title || 'SILVER JEWELLERY'}</Text>
            <View style={styles.headerAccent} />
          </View>
        </LinearGradient>
      </View>
